...
function App() {
  ...
  let activeStyle = {
    color: "dodgerblue",
    fontWeight: "bold",
    textShadow: "0px 0px 3px white,0px 0px 5px white,0px 0px 8px white,0px 0px 11px white",
  };
  ...
  return (
      ...
      <AnimatePresence mode="wait">
        ...
        <motion.nav className={styles.nav}
          ...
          exit="exit"
          style={{
              display: !window.matchMedia(`(max-width:768px)`).matches ?  "flex" : isOpen ? "flex" : "none",
              backgroundColor: dark ? "#000" : "#fff",
          }}
        > 
            <div 
      ...
      <div 
        style = {{
          position: "fixed",
            display: window.matchMedia(`(max-width: 768px)`).matches ? isOpenFloatingBurger ? "flex" : "none" : "none",
          top: "10px",
          right: "0px",
          zIndex: "5",
        }} >
      ...
      > 
        ...
        <span>|</span>
        <span onClick={() => {setIsPPModalOpen(true)}}>Privacy Policy</span>
        <span>|</span>
        <span>GDPR</span>
      </footer>
    </main>
